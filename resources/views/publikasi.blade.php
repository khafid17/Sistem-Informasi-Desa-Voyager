      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-8 entries">
            ...
            @foreach ($posts->chunk(2) as $articleChunk)
            <div class="row">
              @foreach ($articleChunk as $post)
              <div class="col card md-1 ml-1 mb-1 mt-1">
              ...
              <div class="entry-meta">
                <ul>
                  <li class="d-flex align-items-center"><i class="icofont-user"></i> <a>Publikasi {{$post->created_at}}</a></li>
                </ul>
              </div>
            ...
            @endforeach
{{-- 
            @foreach ($post->chunk(3) as $articleChunk)
            <div class="row">
